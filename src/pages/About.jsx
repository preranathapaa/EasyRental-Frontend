...
const AboutUs = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white px-4 md:px-16 py-10">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div>
          <img
            ...
            alt="Motorcycle"
            className=" h-[600px] w-[600px] shadow-lgn object-fill"
          />
        </div>

        {/* Right - Text */}
        <div className="max-w-xl p-6 bg-gray-100 rounded-2xl shadow-lg">
